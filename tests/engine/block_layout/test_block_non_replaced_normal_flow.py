...
class WidthTests(LayoutTestCase):
    def test_no_horizontal_properties(self):
        node = ExampleNode(name="div", style=CSS(display=BLOCK, height=10))
    ...
    def test_width(self):
        node = ExampleNode(name="div", style=CSS(display=BLOCK, width=50, height=10))
...
class HeightTests(LayoutTestCase):
    def test_no_vertical_properties(self):
        node = ExampleNode(name="div", style=CSS(display=BLOCK, width=10))
    ...
    def test_height(self):
        node = ExampleNode(name="div", style=CSS(display=BLOCK, width=10, height=50))
