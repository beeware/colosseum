...
class WidthTests(LayoutTestCase):
    def test_no_horizontal_properties(self):
        node = ExampleNode(name="span", style=CSS(display=INLINE))
    ...
    def test_auto_left_margin(self):
        node = ExampleNode(name="span", style=CSS(display=INLINE, margin_left=AUTO))
        node.intrinsic.width = 50
        node.intrinsic.height = 10
    ...
    def test_auto_right_margin(self):
        node = ExampleNode(name="span", style=CSS(display=INLINE, margin_right=AUTO))
        node.intrinsic.width = 50
        node.intrinsic.height = 10
