...
from ...utils import ExampleNode, LayoutTestCase
...
class WidthTests(LayoutTestCase):
    def test_auto_left_margin(self):
        node = ExampleNode(name="img", style=CSS(display=INLINE, margin_left=AUTO))
    ...
    def test_auto_right_margin(self):
        node = ExampleNode(name="img", style=CSS(display=INLINE, margin_right=AUTO))
        node.intrinsic.width = 50
        node.intrinsic.height = 10
        node.intrinsic.is_replaced = True
    ...
    def test_intrinsic_height_and_ratio(self):
        node = ExampleNode(name="img", style=CSS(display=INLINE))
        node.intrinsic.height = 10
    ...
    def test_height_and_intrinsic_width(self):
        node = ExampleNode(name="img", style=CSS(display=INLINE, height=30))
        node.intrinsic.width = 50
        node.intrinsic.is_replaced = True
...
class HeightTests(LayoutTestCase):
    def test_auto_top_margin(self):
        node = ExampleNode(name="img", style=CSS(display=INLINE, margin_top=AUTO))
        node.intrinsic.width = 50
        node.intrinsic.height = 10
        node.intrinsic.is_replaced = True
    ...
    def test_auto_bottom_margin(self):
        node = ExampleNode(name="img", style=CSS(display=INLINE, margin_bottom=AUTO))
        node.intrinsic.width = 50
        node.intrinsic.height = 10
        node.intrinsic.is_replaced = True
    ...
    def test_width_and_intrinsic_height(self):
        node = ExampleNode(name="img", style=CSS(display=INLINE, width=50))
    ...
    def test_width_and_height(self):
        node = ExampleNode(name="img", style=CSS(display=INLINE, width=50, height=30))
        node.intrinsic.is_replaced = True
