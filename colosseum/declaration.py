...
from .constants import (  # noqa
    ...
    COLOR_CHOICES, DIRECTION_CHOICES, DISPLAY_CHOICES, FLEX_BASIS_CHOICES,
    FLEX_DIRECTION_CHOICES, FLEX_GROW_CHOICES, FLEX_SHRINK_CHOICES,
    FLEX_START, FLEX_WRAP_CHOICES, FLOAT_CHOICES, GRID_AUTO_CHOICES,
    ...
    STRETCH, TEXT_ALIGN_CHOICES, TEXT_DECORATION_CHOICES, TEXT_INDENT_CHOICES,
    TEXT_TRANSFORM_CHOICES, TRANSPARENT, UNICODE_BIDI_CHOICES,
